...
/**
 * Checks if the link-time version of the OS is at least version iOS7.0.
 */
BOOL TTOSVersionIsAtLeast7();

/**
 * Checks if the link-time version of the OS is at least version iOS6.0.
 */
BOOL TTOSVersionIsAtLeast6();
...
extern const CGFloat ttDefaultStatusBarHeight;
...
#define TT_STATUSBAR_HEITH            ttDefaultStatusBarHeight
